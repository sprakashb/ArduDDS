...
//--------------
void set_sb()   // sel sidebands lsb, usb, cw and am.   '4' key selects in this sequence only
{
  modeTime= millis();
  currSB = currSB +1;   //currSB  0 = LSB 1 = USB  2 = CW  3 = AM  SBList[] = { "LSB", "USB", "CW", "AM"};
  if(currSB == 4)
    currSB = 0;
  //showInfo();    // is it reqd here?
}
//---------------------
...
void sel_stepsize()      // freq change stepsize '7' key
{
  ...
  modeTime = millis();
  encoderMsg();
  //showFreq(currFreq);   // is it needed here??
  //delay(100);
}
//-----------------
